...
2. **Interface captures.** The refinance journey is captured end-to-end — loan row → refinance card
   ...
   (https://youtu.be/z07TxLJLC2w). The **open** journey is captured end-to-end as well, in the four
   ...
   ([`10`](./10_UAT_Report_Journey_4_M2.md)); the seven mainnet **Open** transactions themselves have
   ...
   ([`06`](./06_UAT_Report_Journey_1_M2.md), [`07`](./07_UAT_Report_Journey_2_M2.md) §1 steps 11–13,
   and [`09`](./09_UAT_Report_Journey_3_M2.md) §1 steps 10–13) — and only
   [`09`](./09_UAT_Report_Journey_3_M2.md) records it inside a screen recording; the app state after
...
| **Four manual end-to-end walkthroughs** on preprod, *Open → View → Refinance → View*, in opposite asset directions, on three wallets, one of them filling two pools | pass — and the fee, health factor and resulting debt the interface quoted **before** signing are the ones the chain holds afterwards | [`00` §C](./00_POA_SUBMISSION_FORM.md#four-complete-journeys-captured-screen-by-screen) · [`06`](./06_UAT_Report_Journey_1_M2.md) · [`07`](./07_UAT_Report_Journey_2_M2.md) · [`09`](./09_UAT_Report_Journey_3_M2.md) · [`10`](./10_UAT_Report_Journey_4_M2.md) |
